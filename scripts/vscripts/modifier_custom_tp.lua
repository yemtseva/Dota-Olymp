modifier_custom_tp = class({})

--------------------------------------------------------------------------------

function modifier_custom_tp:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_custom_tp:OnCreated( kv )
	if IsServer() then
...
function modifier_custom_tp:OnDestroy()
	if IsServer() then
...
function modifier_custom_tp:OnIntervalThink()
	if IsServer() then
		StopSoundOn( "Hero_Furion.Teleport_Grow", self:GetCaster() )
		StopSoundOn( "Hero_Furion.Teleport_Grow", self:GetCaster() )
